...
# 3. Preprocessing with proper tensor handling
def preprocess_function(examples):
    try:
        ...
        # Convert to lists to avoid numpy/tensor issues
        return {
            "input_ids": [x.tolist() for x in inputs["input_ids"]],
            "attention_mask": [x.tolist() for x in inputs["attention_mask"]],
